...
Future<void> _deleteTask(BuildContext context) async {
  ...
  try {
    ...
    final result = await taskService.deleteTaskById(widget.taskId); // ✅ Use the method from the instance
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(widget.category, style: const TextStyle(color: Colors.grey, fontSize: 15)),
              const SizedBox(height: 16),
              Row(
                children: [
                  const Icon(Icons.calendar_month, color: Color(0xFF5E32E0), size: 28),
                  const SizedBox(width: 8),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Deadline Missed', style: TextStyle(color: Colors.grey, fontSize: 13)),
